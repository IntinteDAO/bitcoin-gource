...
sed -i 's/s_nakamoto/Satoshi Nakamoto/gi' bitcoin-core-project.txt
sed -i 's/--author=//gi' bitcoin-core-project.txt
sed -i 's/sirius-m/Martti Malmi/gi' bitcoin-core-project.txt

cp ../../manual-fix/avatar/* avatar/